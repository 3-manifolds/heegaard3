        ...
        if(NumGenerators == 2 && NumRelators == 2)
            ...
            ******************************************************************************/    
            ...
            if(InitialNumGenerators == NumGenerators && Input == DUALIZE)
                ...
                if(Lens_Space_D(k,TRUE) == TOO_LONG) return(TOO_LONG);
                LensSpace = TRUE;
                return(0);    
                }
        ...
        if(j)
            ...
            **********************************************************************************/
            ...
            if(NumGenerators == 2 && NumRelators == 2)
                ...
                if(InitialNumGenerators == NumGenerators && Input == DUALIZE)
                    {
                    if(Lens_Space_D(i,TRUE) == TOO_LONG) return(TOO_LONG);
                    LensSpace = TRUE;
                    return(FALSE);
                    }
            ...
            **********************************************************************************/
            ...
            if(Micro_Print == 1 && length == Length && !EmtyRel)
                {
...
unsigned int Proper_Power(void)
{        
    /******************************************************************************************
...
int Lens_Space_D(int Prim,char F1)
{
    /******************************************************************************************
...
unsigned int Lens_Space(void)
{
    ...
    ******************************************************************************************/
    ...
    /******************************************************************************************    
         Then call Whitehead_Graph() to actually find the diagram. If Whitehead_Graph()
...
int Transverse(unsigned char *ptr)
{
    /******************************************************************************************
...
unsigned long Recip_Mod_P(unsigned long p,unsigned long q)
{
    /******************************************************************************************
...
unsigned long LGCD(unsigned long p,unsigned long q)
{
    /******************************************************************************************
...
unsigned int Split_At_Empty_Relators(int F1)
{
